...
public class DataBase {
	...
	public static String USER = "bosscommon";
	public static String PASSWORD = "bosscommon2014";
	public static String ConnectionURL = "jdbc:microsoft:sqlserver://192.168.61.229:1433;DatabaseName=";
